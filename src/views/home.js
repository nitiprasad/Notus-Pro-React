    ...
    <div className={styles['container']}>
      ...
      <div className={styles['Hero']}>
        <div className={styles['Bg']}>
          <img
            alt="image"
            src="/playground_assets/international%20center%20of%20agroecology%20logo%20%5B2500%20x%201500%20px%5D-800w.jpeg"
          ...
          <div className={styles['Container04']}>
            ...
            >
              <span className={styles['text05']}>
                Nestled in the heart of Old Bridge, New Jersey, the
                International Center for Agroecology (ICA), enjoys a thick
                growth of natural vegetation and wetlands, untouched by urban
                encroachment.
              </span>
            </span>
          </div>
          ...
          <div className={styles['WorkWithUs']}>
            ...
            <div className={styles['container10']}>
              ...
              <div className={styles['container12']}>
                <h4
                  className={` ${styles['text15']} ${projectStyles['healine']} `}
                >
                  <span className={styles['text16']}>Volunteering</span>
                  <br></br>
                </h4>
                <span className={styles['text17']}>
                  IInsert text here for volunteer oppor
                  <span
                    dangerouslySetInnerHTML={{
                      __html: ' ',
                    }}
